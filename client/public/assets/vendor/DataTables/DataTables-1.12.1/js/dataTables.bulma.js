...
DataTable.ext.renderer.pageButton.bulma = function ( settings, host, idx, buttons, page, pages ) {
	...
	var nav = $('<nav className="pagination" role="navigation" aria-label="pagination"><ul className="pagination-list"></ul></nav>');
...
$(document).on( 'init.dt', function (e, ctx) {
	...
	$( 'div.dataTables_length select', api.table().container() ).wrap('<div className="select">');

	// Filtering input
	// $( 'div.dataTables_filter.ui.input', api.table().container() ).removeClass('input').addClass('form');
	// $( 'div.dataTables_filter input', api.table().container() ).wrap( '<span className="ui input" />' );
} );
